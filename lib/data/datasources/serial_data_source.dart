...
import 'package:greenhouse/domain/entities/weather_data.dart';
import 'package:greenhouse/data/datasources/climate_data_source.dart';
import 'package:greenhouse/data/datasources/modbus_service.dart';
...
class SerialDataSource implements ClimateDataSource {
  ...
  Future<void> _connect() async {
    try {
      ...
      log('Connected to Modbus RTU on $portName');
  ...
  Future<void> setIrrigationValve(int valveId, bool on) async {
    ...
    log('Serial: Setting Valve $valveId (Addr $address) to $on');
